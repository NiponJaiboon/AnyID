...
namespace iSabaya
{
	...
	public class StateTransition
	{
		...
		{
			//if (fromState != null) fromState.Persist(context);
			//if (toState != null) toState.Persist(context);
			if (transitionRule != null) transitionRule.Persist(context);
