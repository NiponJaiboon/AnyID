...
namespace iSabaya
{
    ...
    public class PersonConfig
    {
        ...
        public virtual TreeListNode GetGender(string genderCode)
        {
            return this.GenderRootNode.GetDescendant(genderCode);
        }

        public virtual TreeListNode GetMaritalStatus(string code)
        {
            return this.MaritalStatusRootNode.GetDescendant(code);
        }
    }
}
