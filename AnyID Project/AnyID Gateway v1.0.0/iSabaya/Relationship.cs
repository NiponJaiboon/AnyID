...
//            if (this.enteringEventRule != null) this.enteringEventRule.Persist(context);
//            if (this.exitingEventRule != null) this.exitingEventRule.Persist(context);
//            if (this.validationRule != null) this.validationRule.Persist(context);
