...
namespace iSabaya
{
    public class ChainOfCommand : InterPositionRelation
    {
        public ChainOfCommand()
        {
        }

        public ChainOfCommand(TimeInterval effectivePeriod, OrgUnitPosition superiorPosition, OrgUnitPosition subordinatePosition)
        {
